...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','calc.py',54),
  ('statement -> expression','statement',1,'p_statement_expr','calc.py',58),
  ...
  ('expression -> - expression','expression',2,'p_expression_uminus','calc.py',72),
  ('expression -> ( expression )','expression',3,'p_expression_group','calc.py',76),
  ('expression -> NUMBER','expression',1,'p_expression_number','calc.py',80),
  ('expression -> NAME','expression',1,'p_expression_name','calc.py',84),
]
